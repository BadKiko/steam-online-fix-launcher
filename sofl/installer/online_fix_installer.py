...
class OnlineFixInstaller:
            ...
            with rarfile.RarFile(archive_path) as rf:
                ...
                for i, file_info in enumerate(file_list):
                    ...
                    if progress_callback:
                        ...
                        progress_callback(
                            progress, f"Extracting: {int(progress * 100)}%"
                        )
    ...
    def _detect_game_folder(self, base_dir: str, game_name: str) -> str:
        ...
        try:
            ...
            for dir_name in game_dirs:
                if (
                    clean_game_name in dir_name.lower()
                    or dir_name.lower() in clean_game_name
                ):
            ...
            for dir_name in game_dirs:
                ...
                exe_files = [
                    f for f in os.listdir(dir_path) if f.lower().endswith(".exe")
                ]
                if exe_files:
                    return dir_path
    ...
    def _find_game_executable(self, game_dir: str) -> Optional[str]:
        ...
        try:
            ...
            root_executables = [
                exe for exe, _ in valid_executables if os.path.dirname(exe) == game_dir
            ]
            if root_executables:
